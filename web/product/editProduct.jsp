...
<html>
    ...
    <body>
        ...
        <form method="post" action="<%= request.getContextPath() %>/web/product/editProduct.jsp" enctype="multipart/form-data">
            ...
            <div id="editor">
                <c:out value="${productData.productInformation}" escapeXml="false" />
            </div>
            <input type="hidden" name="productInformation" id="productInformation"><br><br>

            <label for="productPicture">Product Picture:</label>
            <input type="file" id="productPicture" name="productPicture"><br><br>
            ...
            <input type="number" id="productPrice" name="productPrice" min="0" step="0.1" value="${productData.productPrice}" required><br><br>

            <label for="quantity">Quantity (Unit):</label>
            <input type="number" id="quantity" name="quantity" min="1" value="${productData.quantity}" required><br><br>
        ...
        <script>
            ...
            document.querySelector("form").addEventListener("submit", function () {
                document.getElementById("productInformation").value = quill.root.innerHTML;
            });
        </script>
