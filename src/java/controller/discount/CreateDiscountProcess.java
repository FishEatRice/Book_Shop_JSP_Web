...
public class CreateDiscountProcess extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Insert new discount
            String NewDisSQL = "INSERT INTO GALAXY.DISCOUNT (DISCOUNT_ID, PRODUCT_ID, DISCOUNT_PRICE, DISCOUNT_EXPIRED, DISCOUNT_SWITCH, DISCOUNT_DETAILS) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            NewDicStmt.setString(6,details);
